        ...
        {tier1Loading ? (
          ...
          <div className="bg-white rounded-lg shadow p-6 mb-8 border-l-4 border-green-500">
            <div className="mb-6 pb-6 border-b">
              ...
              >
                Completed on{" "}
                {new Date(tier1Assessment.created_at).toLocaleDateString()}
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
              ...
              <div>
                ...
                <p
                  ...
                  style={{ fontFamily: "Epilogue, sans-serif" }}
                >
                  {tier1Assessment.current_state?.replace(/_/g, " ")}
                </p>
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6 p-4 bg-blue-50 rounded-lg">
              ...
              <div>
                ...
                <p
                  className={`text-lg font-bold ${
                    tier1Assessment.recommendation_confidence === "HIGH"
                      ? "text-green-600"
                      : tier1Assessment.recommendation_confidence === "MEDIUM"
                        ? "text-yellow-600"
                        : "text-red-600"
                  }`}
                  style={{ fontFamily: "Epilogue, sans-serif" }}
              ...
              <div>
                ...
                <p
                  className={`text-lg font-bold ${
                    tier1Assessment.budget_aligned
                      ? "text-green-600"
                      : "text-yellow-600"
                  }`}
                  style={{ fontFamily: "Epilogue, sans-serif" }}
                >
                  {tier1Assessment.budget_aligned ? "✓ Yes" : "⚠ Review"}
                </p>
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div>
                ...
                <div className="flex flex-wrap gap-2 mt-2">
                  {tier1Assessment.needs_array?.map((need, idx) => (
                    <span
                      key={idx}
              ...
              <div>
                ...
                <p
                  ...
                  style={{ fontFamily: "Epilogue, sans-serif" }}
                >
                  {tier1Assessment.website_scope?.replace(/_/g, " ")}
                </p>
              </div>
              <div>
                <p
                ...
                <p
                  ...
                  style={{ fontFamily: "Epilogue, sans-serif" }}
                >
                  {tier1Assessment.marketing_timing?.replace(/_/g, " ")}
                </p>
              </div>
              <div>
                <p
                ...
                <p
                  ...
                  style={{ fontFamily: "Epilogue, sans-serif" }}
                >
                  {tier1Assessment.timeline_expectation?.replace(/_/g, " ")}
                </p>
              </div>
            </div>
          ...
          <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-6 mb-8">
            ...
            <p
              ...
              style={{ fontFamily: "Literata, serif" }}
            >
              The client needs to complete the Tier 1 assessment form before you
              can assign a program package.
            </p>
          </div>
        )}
