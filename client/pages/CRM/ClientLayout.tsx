  ...
  useEffect(() => {
    const fetchEngagement = async () => {
      try {
        ...
        if (!user.user) {
          setError(
            "You need to accept an invitation to access your project. Check your email for the invitation link.",
          );
          setLoading(false);
          return;
        }
        ...
        if (id) {
          ...
          if (fetchError) {
            ...
            console.error(
              "No engagement data returned for user:",
              user.user?.id,
            );
            setError(
              "No project found for your account. Please ensure you have accepted the invitation and contact support if the issue persists.",
            );
          }
        }
      } catch (err: any) {
