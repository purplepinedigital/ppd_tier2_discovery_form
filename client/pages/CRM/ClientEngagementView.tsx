...
export default function ClientEngagementView() {
  ...
  const canEditResponses = !stages.some(
    (s) => s.stage_number === 0 && s.status === "completed",
  );
  const stage0Completed = stages.some(
    (s) => s.stage_number === 0 && s.status === "completed",
  );
  ...
  return (
    <div className="min-h-screen bg-[#FFFAEE]">
      ...
      <div className="max-w-6xl mx-auto px-6 pb-12 space-y-8">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                ...
                <div>
                  ...
                  <p className="text-lg text-blue-900">
                    {engagement.program || "Not specified"}
                  </p>
                </div>
                <div>
        ...
        <div className="bg-white rounded-lg shadow p-6">
          ...
          <div className="bg-blue-50 p-4 rounded-lg">
            ...
            <p className="text-lg font-bold text-blue-900">
              Stage {engagement.current_stage}:{" "}
              {getStageLabel(engagement.current_stage)}
            </p>
            <p className="text-xs text-gray-500 mt-2">
              Progress: {Math.round((engagement.current_stage / 7) * 100)}%
            </p>
          </div>
        </div>
        ...
        {tier1Assessment && (
          <div
            className={`rounded-lg shadow p-6 ${stage0Completed ? "bg-gray-50 border border-gray-300" : "bg-white"}`}
          >
            <div className="flex items-center justify-between mb-4">
            ...
            {tier1Assessment.needs_array &&
              tier1Assessment.needs_array.length > 0 && (
                <div className="mt-4">
            ...
            {tier1Assessment.recommended_package && (
              <div className="mt-4 p-3 bg-purple-50 rounded">
                ...
                <p className="text-lg font-bold text-purple-600">
                  {tier1Assessment.recommended_package.toUpperCase()}
                </p>
              </div>
            )}
          </div>
        ...
        {tier2Responses && (
          ...
          >
            <div className="flex items-center justify-between mb-4">
              <h3 className="text-xl font-bold text-gray-900">
                📋 Tier 2 Discovery Responses
              </h3>
              {!stage0Completed && canEditResponses && (
                <Button
                  onClick={() => navigate(`/crm/tier2/${id}`)}
                  className="bg-blue-600 hover:bg-blue-700 text-white flex items-center gap-2"
                >
                  <Edit2 size={18} />
                  Edit Responses
            ...
            <Tier2ResponsesClientView
              responses={tier2Responses.responses || []}
              canEdit={canEditResponses && !stage0Completed}
            />
          </div>
        )}
                      ...
                      <div className="flex items-start gap-4 w-full text-left">
                        <div className="flex-1">
                          ...
                          <h4 className="font-semibold text-gray-900">
                            {getStageLabel(stage.stage_number)}
                          </h4>
                          <p className="text-sm text-gray-600 mt-1">
                            {getStageDescription(stage.stage_number)}
                          </p>
                        </div>
                      </div>
                    </AccordionTrigger>
...
function Tier2ResponsesClientView({
  responses,
  canEdit = true,
}: {
