        ...
        {screen === "complete" ? (
          <section className="flex w-full max-w-[1332px] flex-col items-center justify-center gap-5">
            ...
            <div className="flex flex-col items-center justify-center gap-[30px] self-stretch">
              ...
              <div className="w-full max-w-[560px] bg-[#FFF5E6] rounded-lg p-6 border border-[#37306B] border-opacity-20">
                <p
                  className="text-center font-bold text-[#37306B] mb-3"
                  style={{ fontFamily: "Epilogue, sans-serif" }}
                >
                  Your Project Name
                </p>
                {!isEditingProjectName ? (
                  <div className="flex items-center justify-center gap-3">
                    ...
                    <button
                      ...
                      className="text-sm text-[#37306B] hover:underline font-semibold"
                      style={{ fontFamily: "Literata, serif" }}
                    >
                      Edit
                    </button>
                  ...
                  <div className="space-y-2">
                    <input
                      ...
                      className="w-full rounded border border-gray-300 px-3 py-2 text-base focus:border-[#37306B] focus:outline-none"
                      style={{ fontFamily: "Literata, serif" }}
                    ...
                    <div className="flex gap-2 justify-center">
                      <button
                        onClick={() =>
                          updateEngagementProjectName(editedProjectName)
                        }
