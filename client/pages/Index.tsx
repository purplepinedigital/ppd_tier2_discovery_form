...
export default function Index() {
  ...
  const [responses, setResponses] = useState(() => formQuestions.map(() => ""));
  ...
  return (
    <div className="min-h-screen bg-[#FFFAEE] text-black">
      <header className="mx-auto w-full max-w-[1332px] px-4 py-8 sm:px-8 md:px-12 lg:px-24">
        <img
      ...
      <main className="space-y-20 pb-16 sm:space-y-24 sm:pb-20 lg:space-y-28 lg:pb-28">
        {/* Hero Section */}
        <section className="mx-auto w-full max-w-[1332px] px-4 sm:px-8 md:px-12 lg:px-24">
        ...
        <section
          id="discovery-form"
          className="mx-auto w-full max-w-[1332px] px-4 sm:px-8 md:px-12 lg:px-24"
        >
          <div className="rounded-[18px] bg-white/60 p-6 shadow-sm backdrop-blur-sm md:p-10">
            <div className="space-y-6">
              <div className="space-y-3">
                <p
                  ...
                  style={{ fontFamily: "Epilogue, sans-serif" }}
                >
                  {isComplete ? "All sections completed" : currentQuestion.sectionLabel}
                </p>
                <h2
                  className="text-3xl font-normal md:text-[40px]"
                  style={{ fontFamily: "Epilogue, sans-serif" }}
                >
                  {isComplete ? "Thank you for sharing" : currentQuestion.sectionTitle}
                </h2>
                <p
                ...
                {!isComplete && currentQuestion.sectionNote ? (
                  <p
              ...
              <div className="space-y-4">
                <div className="flex flex-col gap-2 md:flex-row md:items-center md:justify-between">
                  ...
                  >
                    {isComplete
                      ? `Completed ${totalQuestions} of ${totalQuestions} questions`
            ...
            <div className="mt-10 border-t border-[#E3DCD2] pt-10">
              {isComplete ? (
                <div className="space-y-8 rounded-[14px] bg-[#FFEDC3] p-8">
                  <h3
                    className="text-2xl font-normal"
                    style={{ fontFamily: "Epilogue, sans-serif" }}
                  >
                  ...
                  <div className="space-y-4 text-sm leading-relaxed" style={{ fontFamily: "Literata, serif" }}>
                    <p>
